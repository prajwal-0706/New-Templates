...
const print_city = (city_id, city_index) => {
  let option_str = document.getElementById(city_id);
  option_str.length = 0; 
  option_str.options[0] = new Option('Select City', '');
  option_str.selectedIndex = 0;
  let city_arr = s_a[city_index].split('|');
...
document.querySelector('form').addEventListener('submit', (e) => {
  ...
  let city = 'Pune';
  fetch(
    `https://api.data.gov.in/resource/44bea382-c525-4740-8a07-04bd20a99b52?api-key=579b464db66ec23bdd000001580b6179470c4aae536e00ea20cd82f7&format=json&limit=all&filters%5Bstate_name%5D=${getData.state}&filters%5Bdistrict_name%5D=${getData.city}`
  )
